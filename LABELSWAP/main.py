...
def main(algorithm, batch_size, learning_rate, e1, e2, lamda, a, xi, lamdaL1, num_glob_iters,
    ...
    if(algorithm == "FPFC"):
        alg = FPFC(batch_size, learning_rate, lamda, a, xi, num_glob_iters, local_epochs, num_users, ratio, dimension, class_num, seed, projectdir, datasetdir)

    if(algorithm == "FPFCL1"):
        alg = FPFCL1(batch_size, learning_rate, lamdaL1, num_glob_iters, local_epochs, num_users, ratio, dimension, class_num, seed, projectdir, datasetdir)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="FPFC", choices=["FedAvg", "LOCAL","PerFedavg", "IFCA", "CFL", "FPFC", "FPFCL1", "PACFL", "LG"]) 
    parser.add_argument("--batch_size", type=int, default=100)
    parser.add_argument("--learning_rate", type=float, default=0.01, help="Local learning rate")
    parser.add_argument("--e1", type=float, default=0.05, help="Parameter of CFL")
    parser.add_argument("--e2", type=float, default=0.1, help="Parameter of CFL")
    parser.add_argument("--lamda", type=float, default=0.4, help="Regularization parameter of FPFC")
    parser.add_argument("--a", type=float, default=3.7, help="Regularization parameter of FPFC")
    parser.add_argument("--xi", type=float, default=1e-6, help="smooth parameter of FPFC")
    parser.add_argument("--lamdaL1", type=float, default=0.4, help="Regularization parameter of FPFCL1")
    parser.add_argument("--num_global_iters", type=int, default = 200, help="Communication rounds")
    ...
    parser.add_argument("--dimension", type=int, default=400, help="dimension of model")
    ...
    parser.add_argument("--ratio", type=float, default=0.5, help="the proportion of active devices at each round")
    ...
    parser.add_argument("--cluster_alpha", type=float, default=2, help="alpha for PACFL")
    parser.add_argument("--project_dir", type=str, default="fmnist_output", choices=["mnist_output", "fmnist_output"])   
    parser.add_argument("--dataset_dir", type=str, default="fmnist_output", choices=["mnist_output", "fmnist_output"])
    ...
    print("Dataset dir: {}".format(args.dataset_dir))
    print("=" * 80)
